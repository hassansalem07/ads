                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="product_count">
                                        <input type="text" readonly name="quantity" id="sst{{$product->id}}" value="{{$product->pivot->quantity}}" title="Quantity:"
                            ...
                            <tr class="bottom_button">
                                ...
                                <td>
                                    <div class="cupon_text d-flex align-items-center">
                                        <label for="">if you have a discount coupon please enter the code</label>
