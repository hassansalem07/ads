...
<header class="header_area sticky-header">
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    <ul class="nav navbar-nav menu_nav ml-auto">
                        ...
                        <li class="nav-item">
                            ...
                            @csrf
                                <input type="submit" style="border: none; background-color: White;" class="nav-link" value="log out">
                            </form>
                        </li>
                        @endif
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="nav-item"><a href="{{route('my.cart')}}" class="cart"><span class="ti-bag"></span></a></li>
                        <li class="nav-item">
    ...
    <div class="search_input" id="search_input_box">
        <div class="container">
            <form class="d-flex justify-content-between" method="POST" action="{{route('search')}}">
                @csrf
